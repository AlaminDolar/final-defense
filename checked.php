...
@keyframes leelaanimate{
   ...
   <body>
     <div class="container text-center" >
     	<br><br>
    	<h1 class="text-center text-success text-uppercase animateuse" > Wisemonkey Quiz World</h1>
    	<br><br><br><br>
      <table class="table text-center table-bordered table-hover">
         ...
         $Resultans = 0;
            ...
            $finalresult = " insert into user(username,totalques, anscorrect) values ('$name','5','$Resultans') ";
